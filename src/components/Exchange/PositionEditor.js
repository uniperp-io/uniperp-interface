                  ...
                  <div className="Exchange-info-row">
                    ...
                    <div className="align-right">
                      {!nextLiquidationPrice && (
                        <div>
                          {!fromAmount && `$${formatAmount(liquidationPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}`}
                          {fromAmount && "-"}
                        </div>
                      )}
                      {nextLiquidationPrice && (
                      ...
                      <div className="align-right">
                        <Tooltip
                          handle={
                            <>
                              <div className="inline-block muted">
                                ${formatAmount(fundingFee, USD_DECIMALS, position.indexToken.displayDecimals, true)}
                                <BsArrowRight className="transition-arrow" />
                              </div>
                              $0
                            </>
