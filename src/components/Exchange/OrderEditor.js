        ...
        <div className="Exchange-swap-section">
          <div className="Exchange-swap-section-top">
            ...
            <div
              ...
              onClick={() => {
                setTriggerPriceValue(formatAmountFree(indexTokenMarkPrice, USD_DECIMALS, position.indexToken.displayDecimals));
              }}
            >
              <Trans>Mark: {formatAmount(indexTokenMarkPrice, USD_DECIMALS, position.indexToken.displayDecimals)}</Trans>
            </div>
          </div>
          ...
          {triggerPrice && !triggerPrice.eq(order.triggerPrice) ? (
            <>
              <span className="muted">
                {triggerPricePrefix} {formatAmount(order.triggerPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}
              </span>
              &nbsp;
              <BsArrowRight />
              &nbsp;
              {triggerPricePrefix} {formatAmount(triggerPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}
            </>
          ) : (
            <span>
              {triggerPricePrefix} {formatAmount(order.triggerPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}
