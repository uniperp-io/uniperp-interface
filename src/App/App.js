...
import { ARBITRUM, getAlchemyWsUrl, getExplorerUrl } from "config/chains";
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use UNIP with its built-in
              browser.
            </Trans>
          ) : (
            <Trans>
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use UNIP
