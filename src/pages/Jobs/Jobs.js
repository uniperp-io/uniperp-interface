        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at UNIP.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at UNIP currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            UNIP is not actively looking for new hires at the moment. However, if you think you can contribute to the
...
//     <ul>
//       <li>Work closely with the UNIP team on the UNIP front-end website.</li>
...
//       </ul>
//       <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 UNIP a year.</p>
