      ...
      <div className="Page-title-section mt-0">
        ...
        {isArbitrum && (
          <div>
            <div className="Page-description">
              <br />
              <Trans>You have {formatAmount(esGmxIouBalance, 18, 2, true)} esUNIP (IOU) tokens.</Trans>
              <br />
              <br />
              <Trans>The address of the esUNIP (IOU) token is {esGmxIouAddress}.</Trans>
              <br />
              <Trans>
                The esUNIP (IOU) token is transferrable. You can add the token to your wallet and send it to another
              ...
              <br />
              <Trans>
                After claiming, the esUNIP tokens will be airdropped to your account on the selected network within 7
                days.
              </Trans>
              <br />
              <Trans>The esUNIP tokens can be staked or vested at any time.</Trans>
              <br />
              <Trans>
                Your esUNIP (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.
              </Trans>
              <br />
              <Trans>
            ...
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esUNIP tokens at a
                  ratio of {formatAmount(currentRatio, 4, 2, true)} {stakingToken} to 1 esUNIP.
                </Trans>
                ...
                <Trans>
                  ...
                  esUNIP at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esUNIP.
                </Trans>
