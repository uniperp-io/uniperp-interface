        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>
                Get fee discounts and earn rebates through the UNIP referral program.
                <br />
                For more information, please read the{" "}
                <ExternalLink href="https://uniperp.gitbook.io/v1/referrals">referral program details</ExternalLink>.
              </Trans>
            </div>
          </div>
        </div>
