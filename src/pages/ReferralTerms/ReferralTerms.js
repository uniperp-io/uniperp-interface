        ...
        <div>
          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.2 uniperp.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
            ...
            <div className="section">
              ...
              <p className="body-text">
                uniperp.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall uniperp.io be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall uniperp.io's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless uniperp.io, its affiliates, members, member, managers,
                ...
                service(s) provided by uniperp.io, or your use of the service(s) provided by uniperp.io, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from uniperp.io, which the token holders of GMX determine. Due to
              ...
              <p className="body-text">
                uniperp.io will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                uniperp.io may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://uniperp.io/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and uniperp.io concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. uniperp.io will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. uniperp.io may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 uniperp.io will have no responsibility or liability for any failure or delay in performance of the Site,
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with uniperp.io
